...
export default function HomePage() {
  return (
    <main className="relative min-h-[100dvh] bg-[var(--bg)] text-white">
      ...
      <section className="relative mx-auto flex min-h-[100dvh] w-full max-w-7xl flex-col justify-start px-4 py-4 sm:px-5 sm:py-5 lg:px-10 lg:py-5">
          ...
          <div className="space-y-2 lg:space-y-1.5">
            <div className="space-y-3 lg:space-y-2">
              <Image
                ...
                width={220}
                height={44}
                className="h-auto w-[138px] sm:w-[170px] lg:w-[190px]"
                priority
              />
              <h1 className="max-w-xl text-3xl font-semibold leading-[0.96] sm:text-4xl lg:text-5xl">
                {eventName}
              </h1>
              <p className="max-w-[52rem] text-sm leading-6 text-white/74 sm:text-base sm:leading-7 lg:text-base lg:leading-6">
                Test your Westminster instincts with five questions inspired by the world of POLITICO Pro.
              </p>
              <p className="hidden max-w-xl text-sm leading-6 text-white/62 lg:block">
